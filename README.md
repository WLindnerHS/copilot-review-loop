...
```bash
git clone https://github.com/YOUR_USERNAME/copilot-review-loop.git ~/copilot-review-loop
...
```bash
git clone https://github.com/YOUR_USERNAME/copilot-review-loop.git ~/.claude/skills/copilot-review-loop
```
